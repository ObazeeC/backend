...
/* ****************************************
* Get inventory by classificationid 
* *************************************** */
async function getInventoryById(inv_id){
  try{
   ...
   console.error("getInventoryBid error " + error)
   throw error
  }
}
...
module.exports = {getClassifications,deleteInventoryItem, getInventoryByClassificationId,getVehicleById, addClassification, addInventory, getInventoryById, updateInventory}
